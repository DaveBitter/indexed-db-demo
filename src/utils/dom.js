...
export const insertTaskInDOM = (task) => {
    ...
    taskTemplate.querySelector('[data-completed-toggle]').addEventListener('click', () => toggleTaskInDOM(task.id));
    taskTemplate.querySelector('[data-remove-button]').addEventListener('click', () => removeTaskFromDom(task.id));
